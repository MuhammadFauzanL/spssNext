            ...
            <div className="p-8">
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <StatCard
                            ...
                            value={projects.reduce((acc, p) => acc + p.responses, 0).toString()}
                            color="green"
                            icon={
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <StatCard
                            ...
                            value={projects.length > 0 ? formatDate(projects[0].updatedAt) : '-'}
                            color="red"
                            icon={
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    {isLoading ? (
                        // Skeleton loading
                        [1, 2, 3].map((i) => (
                            <div key={i} className="h-64 rounded-2xl bg-neutral-100 animate-pulse"></div>
                        ))
                    ) : (
                        <>
                                ...
                                <Link key={project.id} href={`/dashboard/projects/${project.id}`}>
                                    <Card className="h-full">
                                        ...
                                        <div className="flex items-center justify-between text-sm border-t border-neutral-100 pt-4 mt-4">
                                            ...
                                            <span className="text-neutral-500">{formatDate(project.updatedAt)}</span>
                                        </div>
                                    </Card>
                                </Link>
                            ))}
